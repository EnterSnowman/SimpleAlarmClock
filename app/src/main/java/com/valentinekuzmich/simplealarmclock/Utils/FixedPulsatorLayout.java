 ...
 *
 */
public class FixedPulsatorLayout extends RelativeLayout {
     ...
     *                theme, resources, etc.
     */
    public FixedPulsatorLayout(Context context) {
        this(context, null, 0);
    }
     ...
     */
    public FixedPulsatorLayout(Context context, AttributeSet attrs) {
     ...
     *                     for defaults.
     */
    public FixedPulsatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
